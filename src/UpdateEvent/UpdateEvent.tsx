                    ...
                    >
                        <div className="lg:h-[65vh] h-full">
                            ...
                            <Form.Item
                                ...
                                rules={[{ required: true, message: "Please input!" }]}
                            >
                                <Select value={eventTypes} onChange={handleEventType}>
                                ...
                                <div className="w-full flex gap-2">
                                    <span
                                        ...
                                        className={`w-14 h-14 border-[1px] rounded-md bg-white flex items-center justify-center dark:bg-[#ede9fe] ${
                                            isAudioSelected ? "border-[#7c3aed] text-[#7c3aed]" : "border-gray-300 hover:shadow-md hover:border-[#7c3aed] transition-all ease-in-out"
                                            }`}
                                    >
                                    ...
                                    <span
                                        ...
                                        className={`w-14 h-14 border-[1px] rounded-md bg-white flex items-center justify-center dark:bg-[#ede9fe] ${
                                            isVideoSelected ? "border-[#7c3aed] text-[#7c3aed]" : "border-gray-300 hover:shadow-md hover:border-[#7c3aed] transition-all ease-in-out"
                                            }`}
                                    >
