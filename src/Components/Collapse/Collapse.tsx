...
const items: CollapseProps['items'] = [
  {
    key: '1',
    label: <p className='text-xl dark:text-white font-semibold'>How does TimeForge simplify the event creation process?</p>,
  ...
  {
    key: '2',
    label:  <p className='text-xl dark:text-white font-semibold'>Can I categorize different types of events on TimeForge?</p>,
  ...
  {
    key: '3',
    label: <p className='text-xl dark:text-white font-semibold'>What options does TimeForge offer for managing participants in events?</p>,
  ...
  {
    key: '4',
    label: <p className='text-xl dark:text-white font-semibold'>How does TimeForge help users save and manage time effectively?</p>,
