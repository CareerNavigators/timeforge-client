  ...
  return (
    <div className="max-w-6xl mx-auto p-5">
      ...
      <div className="bg-gradient-to-r from-[#9181F4] to-[#5038ED] min-h-fit p-10 text-white rounded-xl">
        <h1 className="text-center text-3xl md:text-4xl tracking-wider font-bold">
          Congratulations!!! Your Reservation is done.
        </h1>
        <h1 className="text-center text-purple-100 text-lg md:text-2xl pt-5 tracking-wider font-semibold">
        ...
        <figure className="flex py-12 justify-center ">
          <svg
            ...
            data-name="Layer 1"
            className="h-52 md:h-60 rounded-xl p-5 bg-gray-100"
        ...
        <h1 className="text-center text-2xl md:text-3xl tracking-wider font-bold">
